...
/// Published crates in this workspace (zenjxl-decoder-cli is `publish = false`).
const CRATES: &[&str] = &[
    "zenjxl-decoder",
    ...
    for package in CRATES {
        ...
        doc.push_str(&format!(
            "# {package} public API surface\n\
             # Generated by zenjxl-decoder/tests-dev/public_api_doc.rs via `cargo public-api --simplified`\n\
